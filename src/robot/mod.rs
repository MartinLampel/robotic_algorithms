    ...
    K: KinematicsModel,
{
    ...
    pub fn localize(&mut self, state: &RobotState, environment: &Environment, dt: f32) -> RobotState {
    ...
    pub fn run_motion_control(&mut self, dt: f32, state: &RobotState, u: &ControlData) -> RobotState {
